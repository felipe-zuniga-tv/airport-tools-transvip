...
export const Spinner = ({ size }: { size? : keyof typeof spinnerSizes }) => {
    return (
        <svg aria-hidden="true" className={`${size ? spinnerSizes[size] : spinnerSizes['SMALL']} mx-auto text-slate-900 animate-spin fill-white`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
